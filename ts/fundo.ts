const bodyCor = document.body as HTMLElement;
const footerCor = document.querySelector("footer") as HTMLElement;
const headerCor = document.querySelector("header") as HTMLElement;
const botaoAleatorio = document.getElementById("botao-fundo") as HTMLButtonElement;
const botaoResetar = document.getElementById("resetar-fundo") as HTMLButtonElement;
