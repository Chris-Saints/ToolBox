...
const selectorDe = document.getElementById("converter-de") as HTMLInputElement;
const selectorPara = document.getElementById("converter-para") as HTMLInputElement;
const bntConverter = document.getElementById("converter-botao") as HTMLInputElement;
const displayResul = document.getElementById("display") as HTMLButtonElement;
