...
const botaoAmPm = document.getElementById("am-pm");
...
const btnAlarme = document.getElementById("btn-alarme");
...
let intervaloTemporizadorId = null; //intervalo pro temporizador deve ser null tbm para que ele possa para 
let tempoRestante = 0; //tempo para contagem regressiva do temporizador
let intervaloId = null; //intervalo pro cronometro deve ser null tbm para que ele possa para 
...
btnTemporizador.addEventListener("click", () => {
    ...
    const espacoDisplay = document.getElementById("espaco-display");
    const btnIniciar = document.getElementById("btn-iniciar");
    const btnPausar = document.getElementById("btn-pausar");
    const btnResetar = document.getElementById("btn-resetar");
    const btnDezMin = document.getElementById("btn-dez-min");
    const btnUmaHora = document.getElementById("btn-hora");
    const btnMeiaHora = document.getElementById("btn-meia-hora");
    ...
    function atualizarDisplayTemporizador(segundosTotais) {
        const horas = Math.floor(segundosTotais / 3600);
        const minutos = Math.floor((segundosTotais % 3600) / 60);
        const segundos = segundosTotais % 60;
        const h = String(horas).padStart(2, "0");
    ...
    function converterStringTempo(tempo) {
