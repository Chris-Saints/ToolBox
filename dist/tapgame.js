"use strict";
const jogar = document.getElementById("jogar"); //Recebe o elemento do botao jogar
const cronometro = document.getElementById("cronometro"); // Recebe o elemento que sera o cronometro
const novoJogo = document.getElementById("novo-jogo"); //Recebe o elemento do botao novo jogo
const ParagrafoContador = document.createElement("p"); //Recebe o proprio paragrafo onde o contador vai aparecer
const div = document.getElementById("div__contador"); //Recebe o elemento da div onde vai ficar o contador
let jogoAtivo = false; // Para que controle a contagem das teclas e voce nao possa apertar antes do jogo começar
const teclasPressionadas = new Set(); //Cria a variavel que vai guardar a tecla apertada para que ela nao conte ao segura-la
let contador = 0; //Cria a varivel que vai contar os clicks
const melhorRecordeElemento = document.getElementById("melhor-recorde"); //Pega o elemento html que fica o recorde
...
const conquistaUm = document.getElementById("conquista-um");
const conquistaDois = document.getElementById("conquista-dois");
const conquistaTres = document.getElementById("conquista-tres");
const conquistaQuatro = document.getElementById("conquista-quatro");
const conquistaCinco = document.getElementById("conquista-cinco");
const itemUm = document.getElementById("item-um");
const itemDois = document.getElementById("item-dois");
const itemTres = document.getElementById("item-tres");
const itemQuatro = document.getElementById("item-quatro");
const itemCinco = document.getElementById("item-cinco");
